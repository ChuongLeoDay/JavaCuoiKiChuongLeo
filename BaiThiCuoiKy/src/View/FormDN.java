...
public class FormDN extends javax.swing.JFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(TFTenTaiKhoan, javax.swing.GroupLayout.DEFAULT_SIZE, 187, Short.MAX_VALUE)
                            .addComponent(TFMK)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(132, 132, 132)
    ...
    private void BTNDKIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTNDKIActionPerformed
        ...
        FormDKI dki = new FormDKI();
        dki.setVisible(true);
        dki.setLocationRelativeTo(null);
        this.dispose();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        if(TFTenTaiKhoan.equals("") || TFMK.equals("")) {
            JOptionPane.showMessageDialog(this, "Bạn không thể để trống thông tin");
        }
        else {
            try {
                
                String TenDangNhap = this.TFTenTaiKhoan.getText();
                String MatKhauTruocMaHoa = this.TFMK.getText();
                AESPass aes = new AESPass("lvvclvvclvvclvvc");
                String MatKhauSauMaHoa = aes.Encryp(MatKhauTruocMaHoa);
                accountDAO accDAO = (accountDAO) Naming.lookup("rmi://localhost:400/AccountSever");
                Account acc;
                acc = accDAO.find(TenDangNhap, MatKhauSauMaHoa);
                if(acc == null) {
                    JOptionPane.showMessageDialog(this, "Đăng nhập thất bại");
                }
                if(MatKhauTruocMaHoa.equals(aes.Decryp(acc.getMatKhau().trim())) == true && TenDangNhap.equals(acc.getTenDangNhap().trim()) == true) {
                    JOptionPane.showMessageDialog(this, "Đăng nhập thành công");
                    Quanlibaido ql = new Quanlibaido();
                    ql.setSize(920, 485);
                    ql.setVisible(true);
